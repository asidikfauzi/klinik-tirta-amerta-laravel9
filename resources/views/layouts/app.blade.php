  ...
  <main id="main">
        ...
        <div class="row no-gutters">
          <div class="col-lg-4 col-md-6">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="#about">Profil</a></h4>
              <p class="description">Profil Klinik Tirta Amerta Kabupaten Sumenep</p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6">
            <div class="icon-box">
              <div class="icon"><i class="bi bi-briefcase"></i></div>
              <h4 class="title"><a href="#clients">Mitra Kerja</a></h4>
              <p class="description">Mitra Kerja Klinik Tirta Amerta Kabupaten Sumenep</p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6">
            <div class="icon-box">
              <div class="icon"><i class="bi bi-calendar4-week"></i></div>
              <h4 class="title"><a href="#services">Jadwal</a></h4>
              <p class="description">Jam Operasional Klinik Tirta Amerta Kabupaten Sumenep</p>
            </div>
          </div>
        </div>
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Profil</h2>
          <p>Profil Klinik Tirta Amerta :</p>
        </div>
    ...
    <section id="clients" class="clients">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Mitra Kerja</h2>
          <p>Klinik Tirta Amerta bekerjasama dengan :</p>
        </div>
        <div class="clients-slider swiper">
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide"><img src="{{asset('assets/img/clients/bpjs.png')}}" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{asset('assets/img/clients/mandiri.png')}}" class="img-fluid" alt=""></div>
          </div>
    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Jadwal Klinik Tirta Amerta</h2>
          <p>Jadwal buka klinik tirta amerta :</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-teal" style="width: 100%;">
              ...
              <h4><a href="">Jum'at</a></h4>
              <p>08:00 AM - 10:00 PM</p>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box iconbox-red" style="width: 100%;">
              <div class="icon">
                <svg width="100" height="100" viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
              ...
              <h4><a href="">Sabtu dan Minggu</a></h4>
              <p>Untuk hari sabtu dan minggu Klinik Tirta Amerta libur dulu cuy.</p>
            </div>
          </div>
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>Jl. Adirasa Blok AA No. 15</p>
              </div>

              <div class="email">
                <i class="bi bi-envelope"></i>
                <h4>Email:</h4>
                <p>tagroup678@gmail.com</p>
              </div>

              <div class="phone">
                <i class="bi bi-phone"></i>
                <h4>Call:</h4>
                <p>+62 8190 9565 554</p>
              </div>

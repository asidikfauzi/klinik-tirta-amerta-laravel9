                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin-create-pasien') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="no_pasien" type="number" class="form-control @error('no_pasien') is-invalid @enderror" name="no_pasien" value="{{$data->no_pasien+1}}" required autocomplete="no_pasien" autofocus>

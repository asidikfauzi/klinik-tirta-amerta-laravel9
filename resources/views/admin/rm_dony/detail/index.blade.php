...
<div class="container">
    ...
    <div class="row mt-4">
        <table id="table-file-gigi" class="display table-file-gigi stripe row-border order-column" style="width: 100%;" >
            <thead>
                <tr>
                    <th>Tgl</th>
                    <th>Lihat Riwayat Dan Catatan</th>
                </tr>
            </thead>
            <tbody>
                <tr></tr>
    ...
    function fetch_data(search='')
    {
        $('.table-file-gigi').DataTable({
            ...
            ajax: {
                ...
                url:"{{ route('admin.getdetail.pasien.gigi') }}",
                data: {
                    search : search,
                }
            },

...
<div class="content">
    ...
    <div class="topnav mb-3">
        <button onclick="window.location.href='{{route('admin.create.pasien.gigi')}}'" class="button button-submit">Tambah Pasien Gigi</button>
...
<script type="text/javascript">
    ...
    function fetch_data(search='')
    {
        $('.table-pasien').DataTable({
            ...
            url:"{{ route('admin.getdata.pasien.gigi') }}",
